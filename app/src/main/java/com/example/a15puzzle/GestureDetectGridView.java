...
//This class was not developed by me, found it on a git repository
            ...
            public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
                ...
                if (Math.abs(e1.getY() - e2.getY()) > SWIPE_MAX_OFF_PATH) {
                    ...
                    if (e1.getX() - e2.getX() > SWIPE_MIN_DISTANCE) {
                        Toast.makeText(context, "Left " + position,Toast.LENGTH_SHORT).show();
                        MainActivity.moveTiles(context, MainActivity.LEFT, position);
                    } else if (e2.getX() - e1.getX() > SWIPE_MIN_DISTANCE) {
                        Toast.makeText(context, "Right " + position,Toast.LENGTH_SHORT).show();
